...
class LoginForm(FlaskForm):
    style = {'class': 'ourClasses',
             'style': 'width: 80%; margin-bottom: 25px; height: 40px; border-radius: 5px; outline: 0; -moz-outline-style: none;'}
    ...
    password = PasswordField('Пароль', validators=[DataRequired()], render_kw=style)
